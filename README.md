...
-   This is a lean and minimal implementation
...
-   There is a log viewer which can be accessed via http://127.0.0.1:8000/log-viewer (only in development environment)
-   The documentation available at http://127.0.0.1:8000/docs/api can only be accessed when you are in development environment
